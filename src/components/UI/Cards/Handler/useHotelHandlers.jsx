...
const handleChange = (e, field) => {
  ...
  if (field === "languagesSpoken" || field === "amenities" || field === "images" || field === "hotelStyle") {
    setFormData((prev) => ({
      ...prev,
...
const handleSubmit = async (e) => {
  ...
  const filteredImages = (formData.images || []).filter((url) => !url.startsWith("blob:"));
  ...
  const invalidAmenities = (formData.amenities || []).filter((id) => !isValidObjectId(id));
